<template lang="html">
  <div class="backdrop" id="add">
    ...
    <div :hide="hide" id="collapse">
      ...
      <input type="text" v-model="fill.subject_code" name="name" value="" />
      <!-- <AutoComplete
      ...
      <input type="text" v-model="fill.subject_course" name="name" value="" />

      <label for="desc">Subject Desc</label>
      <input type="text" v-model="fill.subject_desc" name="desc" value="" />

      <label for="name">Semester</label>
      <input type="text" v-model="fill.subject_sem" name="sem" value="" />
      <!-- <select class="" name="">
                    <option v-for="(sem, s) in sems" :key="s">{{ sem }}</option>
               </select> -->

      <label for="name">Year</label>
      <input type="text" v-model="fill.subject_year" name="year" value="" />
