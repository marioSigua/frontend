    ...
    <div class="grid">
      <div class="row">
          ...
          <div id="sidePanel">
            <div class="container">
              <div class="row row-cols-1">
                <div class="col">
                  <h4 style="color: #503918; float: left;"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-people-fill icon" viewBox="0 0 16 16">
        ...
        <div class="col-sm-6" id="Ssubjects">
          <div id="box">
            <h4 style="color: #503918; float: left;"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-calculator-fill" viewBox="0 0 16 16">
            ...
            <div>
              ...
              <button type="button" class="btn btn-secondary"  data-bs-toggle="tooltip" data-bs-placement="top" title="Save Calculated Grades">
                SAVE
              </button>
              <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Grades" style="margin: 10px;">
                EDIT
              </button>
