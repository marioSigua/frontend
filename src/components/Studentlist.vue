          ...
          <b-card-body>
            <b-card-text>
              <div class="studentlist">
                ...
                <div class="Studentlist">
                  <b-table
                    :items="subj.students.filter((v) => v.isDropped === 0)"
                    :fields="fields"
                    striped
                    hover
                    responsive="sm"
                  >
                    <template #cell(GWA)="row">
                      <b-row class="mb-2">
                        <b-col v-if="row.item.finals_grade === null">
                          {{ null }}
                        </b-col>
                        <b-col v-else>{{
                          (
                    ...
                    <!-- <template #cell(Remarks)>
                      <b-row class="mb-2">
                        <b-col v-if="row.item.GWA >= 75">
                          passed
                        </b-col>
                        <b-col v-else> </b-col>
                      </b-row>
